...
class RoomController extends Controller
{
	...
	public function actionPlay()
	{
		...
		Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . '/js/images.js');
		Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . '/js/functions.js');
		Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . '/js/initialize.js');
		Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . '/js/parser.js');
		Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . '/js/reset.js');
		Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . '/js/update.js');
